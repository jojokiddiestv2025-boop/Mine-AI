      ...
      <div className="p-8 pb-10">
        <div className="flex items-center gap-4">
          ...
          <div>
             ...
             <p className="text-[8px] text-slate-500 font-bold uppercase tracking-[0.4em]">Unlimited v4.2</p>
          </div>
        </div>
      </div>

      <nav className="flex-1 px-4 space-y-2 overflow-y-auto custom-scrollbar overscroll-contain">
        {menuItems.map((item) => (
          <button
            key={item.id}
